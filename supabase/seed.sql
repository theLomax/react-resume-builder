-- ============================================================
-- seed.sql — example data only (role-agnostic)
-- Run after migrations to populate the local dev instance
-- with fictional placeholder data for development/testing.
--
-- Production data lives in react-resume-data and is seeded
-- via the private scripts/seed.ts in that repo.
-- ============================================================

-- Tags (only those needed for the example data below)
insert into tags (id, name) values
  ('00000000-0000-0000-0000-000000000001', 'api'),
  ('00000000-0000-0000-0000-000000000002', 'rest'),
  ('00000000-0000-0000-0000-000000000003', 'scale'),
  ('00000000-0000-0000-0000-000000000004', 'performance'),
  ('00000000-0000-0000-0000-000000000005', 'leadership'),
  ('00000000-0000-0000-0000-000000000006', 'mentoring'),
  ('00000000-0000-0000-0000-000000000007', 'agile'),
  ('00000000-0000-0000-0000-000000000008', 'build-tools'),
  ('00000000-0000-0000-0000-000000000009', 'automation'),
  ('00000000-0000-0000-0000-000000000010', 'integration'),
  ('00000000-0000-0000-0000-000000000011', 'component-library'),
  ('00000000-0000-0000-0000-000000000012', 'design-system'),
  ('00000000-0000-0000-0000-000000000013', 'theming'),
  ('00000000-0000-0000-0000-000000000014', 'vue'),
  ('00000000-0000-0000-0000-000000000015', 'spa'),
  ('00000000-0000-0000-0000-000000000016', 'docker');
...
insert into action_items (id, role_id, default_text, key_experience_text, is_key_experience, weight, display_order) values
  ...
  ('example-product-1', 'example-product', 'Built a component-driven Vue.js SPA, delivering scalable, reusable UI patterns within a Docker environment.',               null,                                                                                                                false, 0.90, 1),
...
insert into action_item_tags (action_item_id, tag_id) values
  ('example-agency-1', '00000000-0000-0000-0000-000000000012'),  -- design-system
  ('example-agency-1', '00000000-0000-0000-0000-000000000011'),  -- component-library
  ('example-agency-1', '00000000-0000-0000-0000-000000000003'),  -- scale
  ('example-agency-1', '00000000-0000-0000-0000-000000000013'),  -- theming
  ('example-agency-1', '00000000-0000-0000-0000-000000000005'),  -- leadership
  ('example-agency-2', '00000000-0000-0000-0000-000000000001'),  -- api
  ('example-agency-2', '00000000-0000-0000-0000-000000000002'),  -- rest
  ('example-agency-2', '00000000-0000-0000-0000-000000000009'),  -- automation
  ('example-agency-2', '00000000-0000-0000-0000-000000000003'),  -- scale
  ('example-agency-2', '00000000-0000-0000-0000-000000000010'),  -- integration
  ('example-agency-3', '00000000-0000-0000-0000-000000000006'),  -- mentoring
  ('example-agency-3', '00000000-0000-0000-0000-000000000007'),  -- agile
  ('example-agency-3', '00000000-0000-0000-0000-000000000005'),  -- leadership
  ('example-product-1', '00000000-0000-0000-0000-000000000014'), -- vue
  ('example-product-1', '00000000-0000-0000-0000-000000000015'), -- spa
  ('example-product-1', '00000000-0000-0000-0000-000000000016'), -- docker
  ('example-product-1', '00000000-0000-0000-0000-000000000011'), -- component-library
  ('example-product-1', '00000000-0000-0000-0000-000000000003'), -- scale
  ('example-product-2', '00000000-0000-0000-0000-000000000009'), -- automation
  ('example-product-2', '00000000-0000-0000-0000-000000000003'), -- scale
  ('example-product-2', '00000000-0000-0000-0000-000000000004'), -- performance
  ('example-product-2', '00000000-0000-0000-0000-000000000008'); -- build-tools
